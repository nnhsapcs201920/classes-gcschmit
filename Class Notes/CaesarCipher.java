...
public class CaesarCipher
{
     ...
     *          
     *  String literal
     *      is a instance of the String class (not a primitive) delinated by double quotes and
    ...
    public static void main(String[] args)
    {
         ...
         *      
         *  For example: generate a random int [1 ... 6]
         */
    ...
    {
        /*
         * Instead of using a "magic number" (e.g., 3.14159), use constants defined by us or the
    ...
    public static String compressKeyphrase(String keyphrase)
    {
        ...
        for(int i = 0; i < keyphraseLength; i++)
        {
             ...
             *          For example, instead of -2, we would specify keyphrase.length() - 2.
             *          
             *  keyphrase:
             *  C A E S A R
             *  0 1 2 3 4 5     <= indicies
             ...
             *      if one or both operands are a String type, + is the string concatentation operator
             *          (operands are converted to String objects); otherwise, + is the addition operator
             *          
             *  int x = 7;
